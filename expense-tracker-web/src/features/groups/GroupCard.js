...
function GroupCard({ id, name, onDeleted }) {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      await axios.delete(
        `${BASE_URL}/groups/${id}?requesterId=${user.id}`
      );
...
const styles = {
  card: {
    background: "#ffffff", padding: "20px", borderRadius: "14px",
    boxShadow: "0 2px 12px rgba(0,0,0,0.07)", display: "flex",
    flexDirection: "column", justifyContent: "space-between",
    minHeight: "130px", transition: "box-shadow 0.2s",
  },
  top: { display: "flex", justifyContent: "space-between", alignItems: "flex-start" },
  name: { fontSize: "17px", fontWeight: "600", color: "#1a1a1a", flex: 1, marginRight: "8px" },
  deleteBtn: {
  ...
  openBtn: {
    marginTop: "16px", background: "#16a085", color: "#fff", border: "none",
  ...
  modal: {
    background: "#fff", borderRadius: "18px", padding: "32px 28px 24px",
  ...
  modalMsg: { fontSize: "14px", color: "#555", lineHeight: "1.6", margin: "4px 0 12px" },
  warning: { color: "#c0392b", fontSize: "13px", fontWeight: "500" },
  btnRow: { display: "flex", gap: "10px", width: "100%", marginTop: "4px" },
  cancelBtn: {
    flex: 1, padding: "11px", borderRadius: "8px", border: "1px solid #e0e0e0",
    background: "#f5f5f5", color: "#555", fontSize: "14px", fontWeight: "500", cursor: "pointer",
  },
  confirmBtn: {
    flex: 1, padding: "11px", borderRadius: "8px", border: "none",
    background: "#e74c3c", color: "#fff", fontSize: "14px", fontWeight: "600", cursor: "pointer",
  },
};